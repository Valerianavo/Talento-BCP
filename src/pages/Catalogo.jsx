...
import { MdSchool, MdBolt, MdMenuBook } from "react-icons/md";
...
function Catalogo() {
    ...
    const filtrados = useMemo(() => {
        ...
        return perfiles
            .filter((p) => {
                ...
                // Búsqueda libre: TODOS los tokens deben estar presentes (AND)
                if (tokens.length > 0) {
    ...
    return (
        <div className="cat-wrapper">
            ...
            {/* TOPBAR — diseño original sin cambios */}
                ...
                <div className="cat-grid-area">
                    <div className="cat-section-header">
                        ...
                        <div className="cat-result-info">
                            ...
                            {hayAlgoActivo && (
                                <button className="cat-limpiar-link" onClick={limpiarTodo}>
                                    Limpiar filtros
                                </button>
                            )}
                        </div>
                    ...
                    {filtrados.length === 0 && (
                        <div className="cat-empty">
                            ...
                            <button className="cat-btn-limpiar" onClick={limpiarTodo}>
                                Limpiar filtros
                            </button>
                        </div>
                    )}
